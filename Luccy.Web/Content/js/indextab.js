(function ($) {
    $.luccytab = {
        ...
        refreshTab: function () {
            ...
            var target = $('.Luccy_iframe[data-id="' + currentId + '"]');
        ...
        activeTab: function () {
            ...
            if (!$(this).hasClass('active')) {
                $('.mainContent .Luccy_iframe').each(function () {
                    if ($(this).data('id') == currentId) {
                        $(this).show().siblings('.Luccy_iframe').hide();
                        return false;
                    }
                });
        ...
        closeOtherTabs: function () {
            $('.page-tabs-content').children("[data-id]").find('.fa-remove').parents('a').not(".active").each(function () {
                $('.Luccy_iframe[data-id="' + $(this).data('id') + '"]').remove();
                $(this).remove();
            });
        ...
        addTab: function () {
            ...
            if (flag) {
                ...
                var str1 = '<iframe class="Luccy_iframe" id="iframe' + dataId + '" name="iframe' + dataId + '"  width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
                $('.mainContent').find('iframe.Luccy_iframe').hide();
        ...
        init: function () {
            ...
            $('.tabCloseAll').on('click', function () {
                ...
                $('.page-tabs-content').children("[data-id]:first").each(function () {
                    $('.Luccy_iframe[data-id="' + $(this).data('id') + '"]').show();
